...
public class LogParserPublisher extends Recorder implements SimpleBuildStep, Serializable {
    ...
    private LogParserPublisher(final boolean unstableOnWarning, final boolean failBuildOnError,
        ...
        this.enableDiffBuild = true;
    }

    @DataBoundConstructor
    public LogParserPublisher(boolean useProjectRule, String projectRulePath,
    ...
    public void perform(Run<?, ?> build, FilePath workspace, Launcher launcher,
        ...
        if (enableDiffBuild) {
            ...
            dbAction = new DiffBuildAction(build, launcher, workspace);
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public boolean configure(final StaplerRequest req, final JSONObject json)
            ...
            useLegacyFormatting = json.getJSONObject("log-parser")
                    .getBoolean("useLegacyFormatting");
            save();
            return true;
        }
    }
